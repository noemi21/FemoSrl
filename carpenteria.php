...
<head>
    ...
    <title>Carpenteria Metallica - Femo Montaggi | Soluzioni su Misura</title>
    <meta name="description" content="Scopri le nostre soluzioni di arredamento commerciale su misura per il tuo negozio o spazio espositivo. Professionalità e qualità garantite da Femo Montaggi.">
    ...
    <style>
        ...
        .navbar-nav .nav-link.active {
            color: #E20512; /* Highlight the active menu item */
        }
...
<body class="d-flex flex-column h-100">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <!-- Toggle btn-->
            <button class="navbar-toggler shadow-none border-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#navbarOffcanvas" aria-controls="navbarOffcanvas" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end fs-5 flex-grow-1 pe-3">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle no-arrow active" role="button" aria-expanded="false">Servizi</a>
    ...
    <main class="flex-shrink-0">
        <div class="container mt-5 py-5">
            <h1 class="fw-light text-center text-lg-start mt-4 mb-0">Carpenteria Metallica</h1>
            <hr class="mt-2 mb-5">
            <div class="row text-center text-lg-start" id="imageGallery">
                <?php foreach ($images as $image): ?>
                    <div class="col-lg-3 col-md-4 col-6">
                        <a class="d-block mb-4 h-100">
                            <img class="img-fluid img-thumbnail" src="<?php echo $image; ?>" alt="Descrizione Immagine" loading="lazy">
                        </a>
                    </div>
                <?php endforeach; ?>
            </div>
